...
## **Two sample t-test -** Analyzing 32 cm Margherita pizza prices + beverage prices

**Question**: Is the average price of margherita + beverage is the same in Budapest vs. Rest of Hungary (other big cities: Debrecen, Szeged, Pécs, Miskolc)
...
**Result**: t = 5.1558, df = 25.865, p-value = 2.262e-05, 95 percent confidence interval: [326.6731; 760.0412]
The p-value is way smaller than the defined 5%, hence, we CAN reject the Null hypothesis. The probability of making a false positive error is about 0.0022%. True difference in means is not equal to 0, hence avg. price of pizza + beverage in Budapest vs. avg. price outside of Budapest differs significantly. 
